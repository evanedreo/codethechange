...
const Hero = () => {
  return (
    <section className="padding-container max-container flex flex-col gap-20 py-5 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      {/* LEFT */}
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 lg:regular-18 xl:regular-20 lg:leading-8 mt-11 tracking-wide text-white">
          ...
          software development, website creation, and much more. 
        </p>
